...
if (document.URL.substring(document.URL.indexOf('=') + 1) === document.URL) {
  ...
  function firstAns() {
    ...
    document.getElementById('nextAns').onclick = function() {
        ...
        const egg = 0;
        const good = 1;
        const sufix = "&fourthattempted=true";
        const sufix1 = "&fourthanswer=wrong";
        const marksAwarded = "&marksawarededfor4=0";
        const totalmarks = marksToDo + egg;
        location.href = "/learn/real_fifth_ques.html" + "?uid=" + uid + sufix + sufix1 + marksAwarded; //+ /**"&marksgotsofar=" + totalmarks**/ 
    }
  }
  function secAns() {
...
document.getElementById('nextAns').onclick = function() {
    ...
    const good = 1;
    const sufix = "&fourthattempted=true";
    const sufix1 = "&fourthanswer=correct";
    const marksAwarded = "&marksawarededfor4=2";
